...
window.APP_CONFIG = {
  ...
  // 6. Google Gemini AI API Key (Optional - get free key from: https://aistudio.google.com/apikey)
  // Used for Smart AI Voice Mic, Quick Entry, and Ask Balance Assistant
  geminiApiKey: ""
};
