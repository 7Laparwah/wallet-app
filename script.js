...
const PERSONAL_CATEGORY_KEYWORDS = [
 ...
 'office expence', 'office expense', 'office', 'bank charges', 'bank charge',
...
const INVESTMENT_KEYWORDS = [
 ...
 'other goal', 'apj emi', 'emi', 'loan', 'car emi', 'bike emi', 'home loan'
];
...
function syncProfileBudgetLimitDisplay(){
 const el = document.getElementById('profileBudgetLimitDisplay');
 if (el) el.textContent = '₹' + getMonthlyBudgetLimit().toLocaleString('en-IN');
}
