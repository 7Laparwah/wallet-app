...
async function submitQuickAdd(){
 ...
 if (!line) { alert("Please enter transaction details"); return; }
 ...
 if (!party) { alert("Please enter a party name"); return; }
...
function saveMonthlyBudgetLimit(){
 ...
 if (isNaN(val) || val <= 0) {
  alert("Please enter a valid budget amount (e.g. 20000)");
  return;
 }
