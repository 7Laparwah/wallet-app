...
// Config is loaded securely from window.APP_CONFIG (config.js).
// If running from a public clone without config.js, safe placeholders are used.
const firebaseConfig = (window.APP_CONFIG && window.APP_CONFIG.firebaseConfig) || {
